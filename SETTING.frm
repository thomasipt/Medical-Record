...
Begin VB.Form SETTING 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   225
         Left            =   120
         OleObjectBlob   =   "SETTING.frx":0070
         TabIndex        =   9
         Top             =   510
         Width           =   1560
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
         Height          =   225
         Left            =   120
         OleObjectBlob   =   "SETTING.frx":00DA
         TabIndex        =   10
         Top             =   765
         Width           =   1560
      End
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
         Height          =   225
         Left            =   120
         OleObjectBlob   =   "SETTING.frx":0142
         TabIndex        =   11
         Top             =   1020
         Width           =   1560
      End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   630
      OleObjectBlob   =   "SETTING.frx":01AE
      Top             =   4185
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
      Height          =   225
      Left            =   1537
      OleObjectBlob   =   "SETTING.frx":03E2
      TabIndex        =   12
      Top             =   1635
      Width           =   1560
   End
