...
With grid
    ...
    .Col = 1: .ColWidth(1) = 2000: .Text = "ANAMNESE": .CellAlignment = 4
    .Col = 2: .ColWidth(2) = 2000: .Text = "FISIK": .CellAlignment = 4
    .Col = 3: .ColWidth(3) = 2000: .Text = "DIAGNOSA": .CellAlignment = 4
    .Col = 4: .ColWidth(4) = 2000: .Text = "TERAPI": .CellAlignment = 4
    .Col = 5: .ColWidth(5) = 2000: .Text = "OBAT": .CellAlignment = 4
    .Col = 6: .ColWidth(6) = 2000: .Text = "QTY": .CellAlignment = 4
...
If RKTG.RowCount <> 0 Then
   ...
   Do Until RKTG.EOF
      ...
      grid.Row = B
         With grid
            .Col = 0: .Text = RKTG("Tgl_Kunj"): .CellAlignment = 4
            .Col = 1: .Text = RKTG("anamnese")
            .Col = 2: .Text = RKTG("fisik")
            .Col = 3: .Text = RKTG("diagnosa"): .CellAlignment = 4
            .Col = 4: .Text = RKTG("terapi"): .CellAlignment = 4
            .Col = 5: .Text = RKTG("obat"): .CellAlignment = 4
            .Col = 6: .Text = RKTG("qty"): .CellAlignment = 4
         End With
      B = B + 1
      RKTG.MoveNext
   Loop
