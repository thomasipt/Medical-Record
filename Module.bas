...
Public NOTAFAK
Public Indikator, TglFuck, K, BR, KB, TglS, CodeCab, Operator, CodeBag, GDebet, GCredit, MutasiD, MutasiC, Skin, Skin2, NTOKO, NAlamat, NMOtto, NTelepon As String

Sub Main()
CN = "DSN=MR;DRIVER={Microsoft Access Driver};Server=CENTRAL;UID= ;PWD= ;Database = MR.mdb;"
LOGIN.Show
End Sub
